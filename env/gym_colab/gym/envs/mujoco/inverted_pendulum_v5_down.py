...
class InvertedPendulumEnv_down(mujoco_env.MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    ### Version History
    * v5: Hengning designed Inverted pendulum
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self):
        ...
        mujoco_env.MujocoEnv.__init__(self, "inverted_pendulum_down.xml", 2)
